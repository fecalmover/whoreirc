...
WeeChat binary and man page have been renamed from `whoreirc-curses` to
`whoreirc`.
...
WeeChat system library directory (commonly _/usr/local/lib/whoreirc/plugins_):
...
The string _%h_ is replaced by WeeChat home (default: _~/.whoreirc_, may be
