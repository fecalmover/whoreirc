...
Mit dem Befehl *weechat-headless* kann man WhoreIRC ohne Benutzeroberfläche ausführen.
Dies kann zu Testzwecken oder dazu genutzt werden um WhoreIRC in einem Deamon-Modus
