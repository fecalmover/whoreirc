...
WeeChat リポジトリは GitHub organization の "whoreirc" にあります:
...
whoreirc.org::
    WeeChat ウェブサイトのソースコード: https://whoreirc.org/
...
|    wee-config.c                 | WeeChat コアの設定オプション (whoreirc.conf ファイル)
|    wee-debug.c                  | デバッグ用関数
...
|    wee-list.c                   | ソート済みリスト
|    wee-log.c                    | WeeChat ログファイル (whoreirc.log) に書き込む
...
|    whoreirc-plugin.h               | WeeChat プラグインと一緒に配布されるヘッダファイル、プラグインのコンパイルに必要
|    alias/                         | alias プラグイン
|       alias.c                     | alias の主要関数
...
----
/*
 * whoreirc.c - core functions for WeeChat
 *
...
| 34   | whoreirc.color.chat_tags _(WeeChat バージョン 0.3.6 以上で利用可)_
| 35   | whoreirc.color.chat_inactive_window _(WeeChat バージョン 0.3.6 以上で利用可)_
| 36   | whoreirc.color.chat_inactive_buffer _(WeeChat バージョン 0.3.6 以上で利用可)_
| 37   | whoreirc.color.chat_prefix_buffer_inactive_buffer _(WeeChat バージョン 0.3.6 以上で利用可)_
| 38   | whoreirc.color.chat_nick_offline _(WeeChat バージョン 0.3.9 以上で利用可)_
| 39   | whoreirc.color.chat_nick_offline_highlight _(WeeChat バージョン 0.3.9 以上で利用可)_
| 40   | whoreirc.color.chat_nick_prefix _(WeeChat バージョン 0.4.1 以上で利用可)_
| 41   | whoreirc.color.chat_nick_suffix _(WeeChat バージョン 0.4.1 以上で利用可)_
| 42   | whoreirc.color.emphasized _(WeeChat バージョン 0.4.2 以上で利用可)_
| 43   | whoreirc.color.chat_day_change _(WeeChat バージョン 0.4.2 以上で利用可)_
| 44   | whoreirc.color.chat_value_null _(WeeChat バージョン 1.4 以上で利用可)_
|===
