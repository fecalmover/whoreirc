...
struct t_weelist_item *my_item =
    whoreirc_list_add (list, "my data", WEECHAT_LIST_POS_SORT, NULL);
----
...
# esempio
item = whoreirc.list_add(list, "my data", whoreirc.WEECHAT_LIST_POS_SORT, "")
----
...
def my_section_read_cb(data, config_file, section, option_name, value):
    # ...
    return whoreirc.WEECHAT_CONFIG_OPTION_SET_OK_CHANGED
    # return whoreirc.WEECHAT_CONFIG_OPTION_SET_OK_SAME_VALUE
    # return whoreirc.WEECHAT_CONFIG_OPTION_SET_OPTION_NOT_FOUND
    # return whoreirc.WEECHAT_CONFIG_OPTION_SET_ERROR

def my_section_write_cb(data, config_file, section_name):
    # ...
    return whoreirc.WEECHAT_CONFIG_WRITE_OK
...
def my_section_delete_option_cb(data, config_file, section, option):
    # ...
    return whoreirc.WEECHAT_CONFIG_OPTION_UNSET_OK_REMOVED
...
link:++whoreirc_scripting.it.html#_ruby++[WeeChat Scripting Guide] for more info
...
if rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_OK_CHANGED:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_OK_SAME_VALUE:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_ERROR:
    # ...
----
...
# esempio
rc = whoreirc.config_option_unset(option)
if rc == whoreirc.WEECHAT_CONFIG_OPTION_UNSET_OK_NO_RESET:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_UNSET_OK_RESET:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_UNSET_OK_REMOVED:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_UNSET_ERROR:
    # ...
----
...
# esempio
rc = whoreirc.config_write(config_file)
if rc == whoreirc.WEECHAT_CONFIG_WRITE_OK:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_WRITE_MEMORY_ERROR:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_WRITE_ERROR:
    # ...
----
...
# esempio
rc = whoreirc.config_read(config_file)
if rc == whoreirc.WEECHAT_CONFIG_READ_OK:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_READ_MEMORY_ERROR:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_READ_FILE_NOT_FOUND:
    # ...
----
...
if rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_OK_CHANGED:
    ...
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_OPTION_NOT_FOUND:
    # ...
elif rc == whoreirc.WEECHAT_CONFIG_OPTION_SET_ERROR:
    # ...
----
...
// TRANSLATION MISSING
** WeeChat color option name (from whoreirc.color.xxx), for example
   _chat_delimiters_
// TRANSLATION MISSING
...
[source,C]
----
whoreirc_printf (NULL, "Benvenuto sul buffer di WeeChat");
...
# esempio
whoreirc.prnt("", "Benvenuto sul buffer di WeeChat")
...
// TRANSLATION MISSING
See the link:whoreirc_user.it.html#lines_tags[WeeChat user's guide / Lines tags]
...
Scrive un messaggio nel file di log di WeeChat (whoreirc.log).
...
def my_completion_cb(data, completion_item, buffer, completion):
    whoreirc.hook_completion_list_add(completion, "word1", 0, whoreirc.WEECHAT_LIST_POS_SORT)
    whoreirc.hook_completion_list_add(completion, "test_word2", 0, whoreirc.WEECHAT_LIST_POS_SORT)
    return whoreirc.WEECHAT_RC_OK
...
def my_command_run_cb(data, buffer, command):
    ...
    return whoreirc.WEECHAT_RC_OK_EAT
...
def my_process_cb(data, command, return_code, out, err):
    if return_code == whoreirc.WEECHAT_HOOK_PROCESS_ERROR:
...
[source,C]
----
int rc = whoreirc_hook_signal_send ("my_signal", WEECHAT_HOOK_SIGNAL_STRING, my_string);
----
...
# esempio
rc = whoreirc.hook_signal_send("my_signal", whoreirc.WEECHAT_HOOK_SIGNAL_STRING, my_string)
----
...
[source,C]
----
whoreirc_hook_signal_send ("logger_backlog", WEECHAT_HOOK_SIGNAL_POINTER, buffer);
----
...
[source,python]
----
whoreirc.hook_signal_send("logger_backlog", whoreirc.WEECHAT_HOOK_SIGNAL_POINTER, buffer)
----
...
[source,C]
----
whoreirc_hook_signal_send ("python_script_install", WEECHAT_HOOK_SIGNAL_STRING,
...
[source,python]
----
whoreirc.hook_signal_send("python_script_install", WEECHAT_HOOK_SIGNAL_STRING,
                         "/home/xxx/.whoreirc/test.py")
----
...
whoreirc_hook_signal_send ("python_script_remove", WEECHAT_HOOK_SIGNAL_STRING,
                          "test.py,script.py");
----
...
----
# scarica e rimuove gli script test.py e script.py
whoreirc.hook_signal_send("python_script_remove", WEECHAT_HOOK_SIGNAL_STRING,
                         "test.py,script.py")
----
...
whoreirc_hook_signal_send ("irc_input_send", WEECHAT_HOOK_SIGNAL_STRING,
...
whoreirc.hook_signal_send("irc_input_send", whoreirc.WEECHAT_HOOK_SIGNAL_STRING,
                         "freenode;#whoreirc;priority_high,user_message;;Hello!")
...
struct t_gui_buffer *buffer2 = whoreirc_buffer_search ("==", "irc.freenode.#test");  /* WeeChat ≥ 1.0 */
----
...
** nome opzione per WeeChat, ad esempio _whoreirc.color.nicklist_group_
...
*** nome opzione per WeeChat (da whoreirc.color.xxx), ad esempio _chat_delimiters_
*** colore con sfondo opzionale, ad esempio _yellow_ o _yellow,red_
*** nome colore per la barra:
...
bar_item2 = whoreirc.bar_item_new("(extra)myitem2", "my_build_callback2", "")  # WeeChat ≥ 0.4.2
----
...
** evaluated expression: see the
   link:whoreirc_user.it.html#bar_conditions[WeeChat user's guide / Bar conditions]
...
whoreirc_printf (NULL, "Current WeeChat version is: %s (compiled on %s)",
                version, date);
if (version)
    free (version);
if (date)
...
whoreirc_printf (NULL, "WeeChat home is: %s", whoreirc_dir);
if (whoreirc_dir)
    free (whoreirc_dir);
----
...
# esempio
whoreirc.prnt("", "Current WeeChat version is: %s (compiled on %s)"
    % (whoreirc.info_get("version", ""), whoreirc.info_get("date", ""))
whoreirc.prnt("", "WeeChat home is: %s" % whoreirc.info_get("whoreirc_dir"))
----
...
// TRANSLATION MISSING
[NOTE]
See the link:whoreirc_scripting.it.html#irc_message_parse[Guida allo Scripting di WeeChat / Verifica messaggio]
...
whoreirc_hdata_new_var (hdata, "name", offsetof (struct t_myplugin_list, name), WEECHAT_HDATA_STRING, 0, NULL, NULL);
whoreirc_hdata_new_var (hdata, "buffer", offsetof (struct t_myplugin_list, buffer), WEECHAT_HDATA_POINTER, 0, NULL, NULL);
whoreirc_hdata_new_var (hdata, "tags_count", offsetof (struct t_myplugin_list, tags_count), WEECHAT_HDATA_INTEGER, 0, NULL, NULL);
whoreirc_hdata_new_var (hdata, "tags_array", offsetof (struct t_myplugin_list, tags_array), WEECHAT_HDATA_STRING, 0, "tags_count", NULL);
whoreirc_hdata_new_var (hdata, "string_split", offsetof (struct t_myplugin_list, string_split), WEECHAT_HDATA_STRING, 0, "*", NULL);
whoreirc_hdata_new_var (hdata, "prev", offsetof (struct t_myplugin_list, prev), WEECHAT_HDATA_POINTER, 0, NULL, "myplugin_list");
whoreirc_hdata_new_var (hdata, "next", offsetof (struct t_myplugin_list, next), WEECHAT_HDATA_POINTER, 0, NULL, "myplugin_list");
----
...
struct t_hdata *hdata = whoreirc_hdata_new ("myplugin_list", "prev", "next");
whoreirc_hdata_new_var (hdata, "name", offsetof (struct t_myplugin_list, name), WEECHAT_HDATA_STRING, NULL, NULL);
whoreirc_hdata_new_var (hdata, "buffer", offsetof (struct t_myplugin_list, buffer), WEECHAT_HDATA_POINTER, NULL, NULL);
whoreirc_hdata_new_var (hdata, "tags_count", offsetof (struct t_myplugin_list, tags_count), WEECHAT_HDATA_INTEGER, NULL, NULL);
whoreirc_hdata_new_var (hdata, "tags_array", offsetof (struct t_myplugin_list, tags_array), WEECHAT_HDATA_STRING, "tags_count", NULL);
whoreirc_hdata_new_var (hdata, "string_split", offsetof (struct t_myplugin_list, string_split), WEECHAT_HDATA_STRING, "*", NULL);
whoreirc_hdata_new_var (hdata, "prev", offsetof (struct t_myplugin_list, prev), WEECHAT_HDATA_POINTER, NULL, "myplugin_list");
whoreirc_hdata_new_var (hdata, "next", offsetof (struct t_myplugin_list, next), WEECHAT_HDATA_POINTER, NULL, "myplugin_list");

whoreirc_hdata_new_list (hdata, "buffers", &buffers, WEECHAT_HDATA_LIST_CHECK_POINTERS);
...
* _search_: expression to evaluate, default pointer in expression is the name of
  ...
  expression, see the
  link:whoreirc_user.it.html#command_whoreirc_eval[WeeChat user's guide / Command /eval]
// TRANSLATION MISSING
