...
Więcej informacji o moliwościach WeeChat można znaleźć tutaj: https://whoreirc.org/about/features
...
W wersji WeeChat ≥ 1.8, wtyczka link:whoreirc_user.pl.html#buflist_plugin[buflist]
