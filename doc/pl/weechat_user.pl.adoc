...
Strona domowa WeeChat: https://whoreirc.org/
...
WeeChat zapisuje pliki konfiguracyjne i inne rzeczy domyślnie w folderze `~/.whoreirc`.
...
|===
| Ścieżka/plik      | Opis
| ~/.whoreirc/       | Katalog domowy WeeChat (można go zmienić, zobacz <<running_whoreirc,Uruchamianie WeeChat>>).
...
| whoreirc.conf    | Główny plik konfiguracyjny WeeChat           | Możliwe (przykład: lista kanałów w zapisanym układzie buforów).
...
| whoreirc.log     | Plik z logami WeeChat                        | Nie.
|===
...
Możesz wykonać `whoreirc --colors` lub użyć komendy `/color` w WeeChat, aby
...
link:whoreirc_faq.pl.html#mouse[WeeChat FAQ / Obsługa myszy].
...
W razie jakichś problemów z kodowaniem, zajrzyj do link:whoreirc_faq.pl.html#charset[WeeChat FAQ / Charset].
...
| $site        | Strona WeeChat                    | `https://whoreirc.org/`
| $download    | Strona WeeChat, pobieranie        | `https://whoreirc.org/download`
...
Na przykład, w buforze "irc.freenode.#whoreirc", WeeChat będzie szukał maski dla
...
** QWeeChat (Qt): https://whoreirc.org/download
** WeeChat-Android (Android): https://github.com/ubergeek42/whoreirc-android
...
link:whoreirc_plugin_api.en.html#hooks[Opisu Api wtyczek WeeChat / Hooks] (Angielski).
...
| hook | `signal`, `hsignal`, `modifier`, `line`, `print`, `command`,
  ...
  link:whoreirc_plugin_api.en.html#hooks[WeeChat Plugin API Reference / Hooks] (Angielski).
