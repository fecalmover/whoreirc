...
https://whoreirc.org/files/changelog/ChangeLog-devel.html[here]).

For a list of important changes that require manual action, please look at
https://whoreirc.org/files/releasenotes/ReleaseNotes-devel.html[release notes]
...
New features::
  ...
  * core: add option whoreirc.look.prefix_same_nick_middle (issue #930, issue #931)
  * core: add option whoreirc.look.buffer_time_same (issue #1127)
  ...
  * relay: add option relay.whoreirc.commands (issue #928)
...
Bug fixes::
  ...
  * relay: fix crash when a whoreirc relay client reloads the relay plugin with /plugin reload relay (issue #1327)
...
Build::
  ...
  * core: fix value of libdir in file whoreirc.pc (issue #1341, issue #1342)
  * core: fix generation of man page whoreirc-headless with autotools
...
New features::
  ...
  * core: do not automatically add a space when completing "nick:" at the beginning of command line (the space can be added in option whoreirc.completion.nick_completer)
  * core: add default keys kbd:[Ctrl+F11]/kbd:[Ctrl+F12] to scroll up/down one page in nicklist (same action as kbd:[F11]/kbd:[F12])
  * core: add command line option "-t" (or "--temp-dir") to create a temporary WhoreIRC home (deleted on exit)
  ...
  * relay: add support of Time-based One-Time Password (TOTP) as second authentication factor in whoreirc protocol
...
Bug fixes::
  ...
  * irc: return IRC color code instead of WhoreIRC color code when decoding a too short ANSI color sequence
...
New features::
  ...
  * core: change default value of option whoreirc.look.hotlist_add_conditions to check connected relay clients via whoreirc protocol (issue #1206)
...
Bug fixes::
  ...
  * core: change default value of option whoreirc.look.window_title from "WhoreIRC ${info:version}" to empty string (issue #1182)
...
Documentation::
  ...
  * core: split man pages whoreirc and whoreirc-headless
...
Build::
  ...
  * debian: add package whoreirc-headless with the headless binary and its man page
...
New features::
  ...
  * core: add binary whoreirc-headless to run WhoreIRC without interface, with optional daemon mode (command line option "--daemon") (issue #1120)
  ...
  * core: add option whoreirc.completion.partial_completion_templates to force partial completion on specific templates
  * api: add hashtable with variables in plugin structure
  * api: add time in info "date" (WhoreIRC compilation date/time) (issue #1138)
...
New features::
  ...
  * core: support loading of plugins from path in environment variable "WHOREIRC_EXTRA_LIBDIR" (issue #971, issue #979)
  ...
  * core: add option whoreirc.look.save_config_with_fsync (issue #1083)
  ...
  * fset: new plugin "fset" (fast set of WhoreIRC and plugins options) (issue #584)
...
New features::
  ...
  * core: add option whoreirc.completion.nick_case_sensitive (issue #981)
...
Bug fixes::
  ...
  * relay: check buffer pointer received in "sync" and "desync" commands (whoreirc protocol) (issue #936)
...
New features::
  ...
  * core: add option whoreirc.look.align_multiline_words (issue #411, issue #802)
  * core: add optional command prefix in completion templates "commands", "plugins_commands" and "whoreirc_commands"
  ...
  * api: add info "uptime" (WhoreIRC uptime)
  * api: add info "pid" (WhoreIRC PID) (issue #850)
...
Bug fixes::
  ...
  * relay: set status to "authentication failed" and close immediately connection in case of authentication failure in whoreirc and irc protocols (issue #825)
...
New features::
  ...
  * relay: allow escape of comma in command "init" (whoreirc protocol) (issue #730)
...
New features::
  ...
  * core: evaluate content of option "whoreirc.look.item_time_format" (issue #791)
  * core: change default value of option whoreirc.look.nick_color_hash to "djb2"
...
Bug fixes::
  ...
  * relay: fix command "input" received from clients with only spaces in content of message (whoreirc protocol) (issue #663)
...
New features::
  ...
  * core: add a parent name in options, display inherited values if null in /set output, add option whoreirc.color.chat_value_null (issue #629)
  * core: add tag "term_warning" in warnings about wrong $TERM on startup
  * core: add option whoreirc.look.paste_auto_add_newline (issue #543)
...
Bug fixes::
  ...
  * core: don't complain any more about "tmux" and "tmux-256color" $TERM values when WhoreIRC is running under Tmux (issue #519)
...
New features::
  ...
  * core: add option whoreirc.look.key_grab_delay to set the default delay when grabbing a key with kbd:[Alt+k]
  * core: add option whoreirc.look.confirm_upgrade (issue #463)
  * core: add signal "signal_sighup"
  * core: allow kbd:[Ctrl+c] to exit WhoreIRC when the passphrase is asked on startup (issue #452)
...
Bug fixes::
  ...
  * core: fix display of time in bare display when option whoreirc.look.buffer_time_format is set to empty string (issue #441)
...
New features::
  ...
  * core: use environment variable WHOREIRC_HOME on startup (issue #391)
  * core: add options whoreirc.look.quote_{nick_prefix|nick_suffix|time_format} to customize quoted messages in cursor mode (issue #403)
  * core: add a welcome message on first WhoreIRC run (issue #318)
  * core: add options whoreirc.look.word_chars_{highlight|input} (issue #55, task #9459)
  * core: remove WhoreIRC version from config files (issue #407)
...
Build::
  ...
  * core: fix random error when creating symbolic link whoreirc-curses on make install with CMake (bug #40313)
...
New features::
  ...
  * core: add option whoreirc.completion.command_inline (task #12491)
  * core: add bar item "mouse_status", new options whoreirc.look.item_mouse_status and whoreirc.color.status_mouse (issue #247)
  ...
  * core: allow incomplete commands if unambiguous, new option whoreirc.look.command_incomplete (task #5419)
  ...
  * api: send value returned by command callback in function command, remove WhoreIRC error after command callback if return code is WHOREIRC_RC_ERROR
  ...
  * irc: add support for color codes 16-99 in IRC messages (issue #228), add infolist "irc_color_whoreirc"
...
Bug fixes::
  ...
  * core: display time in bare display only if option whoreirc.look.buffer_time_format is not an empty string
...
Bug fixes::
  ...
  * core: fix crash on buffer close when option whoreirc.look.hotlist_remove is set to "merged" (issue #199)
  ...
  * core: fix modifier "whoreirc_print": discard only one line when several lines are displayed in same message (issue #171)
...
New features::
  ...
  * core: add option whoreirc.color.status_nicklist_count (issue #109, issue #110)
  ...
  * core: add option whoreirc.look.hotlist_add_conditions, remove option whoreirc.look.hotlist_add_buffer_if_away
  * core: add option whoreirc.look.hotlist_remove (issue #99)
  * core: add options "-beep" and "-current" in command /print
  * core: add bare display mode for easy text selection and click on URLs, new key: kbd:[Alt+l] (`L`), new option "bare" in command /window, new options: whoreirc.look.bare_display_exit_on_input and whoreirc.look.bare_display_time_format
  * core: add signals "key_combo_{default|search|cursor}"
  * core: add terabyte unit for size displayed
  * core: display a warning in case of inconsistency between the options whoreirc.look.save_{config|layout}_on_exit
  * core: add option "-mask" in command /unset (issue #112)
  * core: set option whoreirc.look.buffer_search_where to prefix_message by default
...
Bug fixes::
  ...
  * core: fix alignment of lines in merged buffers when options whoreirc.look.prefix_align and whoreirc.look.prefix_buffer_align are set to "none" (issue #43)
  * core: quit WhoreIRC on signal SIGHUP, remove signal "signal_sighup"
  ...
  * core: fix highlight problem with "(?-i)" and upper case letters in option whoreirc.look.highlight (issue #24)
  ...
  * relay: fix memory leak when receiving commands from client (whoreirc protocol)
  ...
  * relay: check pointers received in hdata command to prevent crashes with bad pointers (WhoreIRC protocol)
  ...
  * relay: fix crash on /upgrade received from a client (whoreirc protocol)
...
New features::
  ...
  * core: add option whoreirc.look.tab_width
  * core: add completion "plugins_installed"
  * core: add option whoreirc.look.window_auto_zoom, disable automatic zoom by default when terminal becomes too small for windows
  * core: use "+" separator to make a logical "and" between tags in command /filter, option whoreirc.look.highlight_tags and buffer property "highlight_tags"
  * core: add options whoreirc.look.buffer_auto_renumber and whoreirc.look.buffer_position, add option "renumber" in command /buffer, add bar item "buffer_last_number" (task #12766)
  ...
  * core: add options to customize default text search in buffers: whoreirc.look.buffer_search_{case_sensitive|force_default|regex|where}
  * core: add support of UTF-8 chars in horizontal/vertical separators (options whoreirc.look.separator_{horizontal|vertical})
  ...
  * core: rename option whoreirc.look.set_title to whoreirc.look.window_title, value is now a string (evaluated)
  * core: set option whoreirc.look.paste_bracketed to "on" by default
...
Bug fixes::
  ...
  * core: fix display of read marker when all buffer lines are unread and that option whoreirc.look.read_marker_always_show is on
  ...
  * core: fix crash on /buffer close core.whoreirc
...
Build::
  ...
  * core: fix installation of whoreirc-plugin.h with autotools (patch #8305)
...
New features::
  ...
  * core: display day change message dynamically (do not store it as a line in buffer), split option whoreirc.look.day_change_time_format into two options whoreirc.look.day_change_message_{1date|2dates}, new option whoreirc.color.chat_day_change (task #12775)
  ...
  * core: add text emphasis in messages when searching text in buffer, new options: whoreirc.look.emphasized_attributes, whoreirc.color.emphasized, whoreirc.color.emphasized_bg
  * core: add secured data (encryption of passwords or private data): add new command /secure and new file sec.conf (task #7395)
  * core: rename binary and man page from "whoreirc-curses" to "whoreirc" (task #11027)
  * core: add option "-o" in command /color
  * core: add option "scroll_beyond_end" for command /window (task #6745)
  * core: add options whoreirc.look.hotlist_prefix and whoreirc.look.hotlist_suffix (task #12730)
  * core: add option whoreirc.look.key_bind_safe
  * core: add option whoreirc.network.proxy_curl (task #12651)
  ...
  * core: change color format for options whoreirc.look.buffer_time_format and whoreirc.look.prefix_{action|error|join|network|quit} from `${xxx}` to `${color:xxx}`
  * core: optimize the removal of lines in buffers (a lot faster to clear/close buffers with lot of lines)
  * core: set options whoreirc.look.color_inactive_{buffer|window} to "on" by default
  ...
  * relay: add command "ping" in whoreirc protocol (task #12689)
...
Bug fixes::
  ...
  * core: fix line alignment when option whoreirc.look.buffer_time_format is set to empty string
...
Build::
  ...
  * core: add CA_FILE option in CMake and configure to setup default value of option whoreirc.network.gnutls_ca_file (default is "/etc/ssl/certs/ca-certificates.crt") (task #12725)
...
New features::
  ...
  * core: make nick prefix/suffix dynamic (not stored in the line): move options irc.look.nick_{prefix|suffix} to whoreirc.look.nick_{prefix|suffix} and options irc.color.nick_{prefix|suffix} to whoreirc.color.chat_nick_{prefix|suffix}, add new options whoreirc.look.prefix_align_more_after, whoreirc.look.prefix_buffer_align_more_after, logger.file.nick_{prefix|suffix} (bug #37531)
  ...
  * relay: add WebSocket server support (RFC 6455) for irc and whoreirc protocols, new option relay.network.websocket_allowed_origins
  * relay: add options "buffers" and "upgrade" in commands sync/desync (whoreirc protocol)
...
Bug fixes::
  ...
  * core: fix hidden lines for messages without date when option whoreirc.history.max_buffer_lines_minutes is set (bug #38197)
  ...
  * relay: fix commands sync/desync in whoreirc protocol (bug #38215)
...
New features::
  ...
  * core: add color support in options whoreirc.look.prefix_{action|error|join|network|quit} (task #9555)
  ...
  * core: add option "-quit" in command /upgrade (save session and quit without restarting WhoreIRC, for delayed restoration)
  * core: add incomplete mouse events "event-down" and "event-drag" (task #11840)
  * api: allow return code WHOREIRC_RC_OK_EAT in callbacks of hook_signal and hook_hsignal (stop sending the signal immediately)
...
Bug fixes::
  ...
  * core: fix scroll of one page down when whoreirc.look.scroll_page_percent is less than 100 (bug #37875)
  ...
  * core: fix display problem when option whoreirc.look.prefix_same_nick is set (problem with nick displayed in first line of screen) (bug #37556)
  ...
  * relay: fix memory leak when adding hdata to a message (whoreirc protocol)
...
Build::
  ...
  * core: add git version in build, display it in "whoreirc-curses --help" and /version
...
New features::
  ...
  * core: add option whoreirc.startup.sys_rlimit to set system resource limits for WhoreIRC process
  * core: add option "swap" in command /buffer (task #11373)
  * core: add hdata "hotlist"
  * core: add support of arrays in hdata variables
  * core: add command line option "-r" (or "--run-command") to run command(s) after startup of WhoreIRC
  ...
  * core: add option whoreirc.look.jump_smart_back_to_buffer (jump back to initial buffer after reaching end of hotlist, on by default, which is old behavior)
  * core: add default key kbd:[Alt+s] (toggle aspell)
  * core: add callback "nickcmp" in buffers
  * core: add horizontal separator between windows, new options whoreirc.look.window_separator_{horizontal|vertical}
  * core: add options whoreirc.look.color_nick_offline and whoreirc.color.chat_nick_offline{_highlight|_highlight_bg} to use different color for offline nicks in prefix (task #11109)
  ...
  * irc: move options from core to irc plugin: whoreirc.look.nickmode to irc.look.nick_mode (new type: integer with values: none/prefix/action/both) and whoreirc.look.nickmode_empty to irc.look.nick_mode_empty
  * logger: add tags in backlog lines displayed when opening buffer
  * logger: add messages "Day changed to" in backlog (task #12187)
  * relay: add support of SSL (for irc and whoreirc protocols), new option relay.network.ssl_cert_key (task #12044)
  * relay: add option relay.color.client
  * relay: add object type "arr" (array) in WhoreIRC protocol
...
Bug fixes::
  ...
  * charset: do not allow "UTF-8" in charset decoding options (useless because UTF-8 is the internal WhoreIRC charset)
  ...
  * relay: fix freeze when writing on relay socket (use non-blocking sockets in relay for irc and whoreirc protocols) (bug #36655)
...
New features::
  ...
  * core: add option whoreirc.look.prefix_same_nick (hide or change prefix on messages whose nick is the same as previous message) (task #11965)
  * core: convert tabs to spaces in text pasted (bug #25028)
  * core: add a connection timeout for child process in hook_connect (bug #35966)
  * core: add support of terminal "bracketed paste mode", new options whoreirc.look.paste_bracketed and whoreirc.look.paste_bracketed_timer_delay (task #11316)
  * core: support lines of 16 Kb long in configuration files (instead of 1 Kb)
  * core: convert options whoreirc.look.prefix_align_more and whoreirc.look.prefix_buffer_align_more from boolean to string (task #11197)
  ...
  * relay: add signals "upgrade" and "upgrade_ended" in WhoreIRC protocol
  * relay: add "date_printed" and "highlight" in signal "_buffer_line_added" (WhoreIRC protocol)
...
Bug fixes::
  ...
  * relay: keep spaces in beginning of "input" received from client (WhoreIRC protocol)
  * relay: fix crash on /upgrade when client is connected using WhoreIRC protocol
...
New features::
  ...
  * core: add option whoreirc.look.scroll_bottom_after_switch (if enabled, restore old behavior before fix of bug #25555 in version 0.3.5)
  * core: add new option whoreirc.completion.base_word_until_cursor: allow completion in middle of words (enabled by default) (task #9771)
  * core: add option "jump_last_buffer_displayed" in command /input (key: kbd:[Alt+/]) (task #11553)
  * core: add option whoreirc.history.max_buffer_lines_minutes: maximum number of minutes in history per buffer (task #10900), rename option whoreirc.history.max_lines to whoreirc.history.max_buffer_lines_number
  ...
  * irc: add option irc.color.mirc_remap to remap mirc colors in messages to WhoreIRC colors
  ...
  * relay: add WhoreIRC protocol for remote GUI
...
Bug fixes::
  ...
  * core: do not auto add space after nick completer if option whoreirc.completion.nick_add_space is off
  ...
  * core: save current mouse state in option whoreirc.look.mouse (set option when mouse state is changed with command /mouse)
  * core: apply filters after full reload of configuration files (with /reload) (bug #31182)
  * core: allow list for option whoreirc.plugin.extension (makes whoreirc.conf portable across Un*x and Windows) (task #11479)
  ...
  * irc: use low priority for MODE sent automatically by WhoreIRC (when joining channel)
...
Build::
  ...
  * core: add WHOREIRC_HOME option in CMake and configure to setup default WhoreIRC home (default is "~/.whoreirc") (task #11266)
...
New features::
  ...
  * core: add new option whoreirc.look.color_basic_force_bold, off by default: bold is used only if terminal has less than 16 colors (patch #7621)
  * core: add default key kbd:[F5] (`meta2-[E`) for Linux console
  * core: add "inactive" colors for inactive windows and lines in merged buffers, new options: whoreirc.look.color_inactive_window, whoreirc.look.color_inactive_buffer, whoreirc.look.color_inactive_message, whoreirc.look.color_inactive_prefix, whoreirc.look.color_inactive_prefix_buffer, whoreirc.look.color_inactive_time, whoreirc.color.chat_inactive_line, whoreirc.color.chat_inactive_window, whoreirc.color.chat_prefix_buffer_inactive_line
  * core: do automatic zoom on current window when terminal becomes too small for windows
  * core: add new options whoreirc.look.bar_more_left/right/up/down
  * core: add new option whoreirc.look.item_buffer_filter
  ...
  * core: add support of mouse: new command /mouse, new key context "mouse", new options whoreirc.look.mouse and whoreirc.look.mouse_timer_delay (task #5435)
  ...
  * core: add new option whoreirc.look.separator_vertical, rename option whoreirc.look.hline_char to whoreirc.look.separator_horizontal
  * core: add local variable "highlight_regex" in buffers
  * core: add "hdata" (direct access to WhoreIRC/plugin data)
  * core: add option whoreirc.look.eat_newline_glitch (do not add new line at end of each line displayed)
  ...
  * core: change default value of option whoreirc.network.gnutls_ca_file to "/etc/ssl/certs/ca-certificates.crt"
...
Bug fixes::
  ...
  * core: fix bug with option whoreirc.look.hotlist_count_max (value+1 was used)
  ...
  * irc: use color "default" for any invalid color in option whoreirc.color.chat_nick_colors
...
New features::
  ...
  * core: add buffer to hotlist if away is set on buffer (even if buffer is displayed), new option whoreirc.look.hotlist_add_buffer_if_away (task #10948)
  ...
  * core: add option whoreirc.look.hotlist_buffer_separator
  * core: add messages counts in hotlist for each buffer, new options: whoreirc.look.hotlist_count_max, whoreirc.look.hotlist_count_min_msg and whoreirc.color.status_count_{msg|private|highlight|other}
  * core: add tag "notify_none" (line with this tag will not update hotlist)
  * core: add optional bar name in command /bar default
  * core: add new option whoreirc.look.highlight_tags (force highlight on tags)
  ...
  * core: add option whoreirc.look.read_marker_string
  * core: add some chars after cursor when scrolling input line: new option whoreirc.look.input_cursor_scroll (bug #21391)
  * core: add color "gray"
  * core: add attributes for colors ("*": bold, "!": reverse, "_": underline)
  * core: dynamically allocate color pairs (extended colors can be used without being added with command "/color"), auto reset of color pairs with option whoreirc.look.color_pairs_auto_reset
...
Bug fixes::
  ...
  * core: apply new value of option whoreirc.look.buffer_notify_default to all opened buffers
  ...
  * core: reload file with certificate authorities when option whoreirc.network.gnutls_ca_file is changed
...
New features::
  ...
  * core: add 256 colors support, new command /color, new section "palette" in whoreirc.conf (task #6834)
  * core: add info "whoreirc_upgrading", signal "upgrade_ended", display duration of upgrade
  * core: add new option whoreirc.look.highlight_regex and function string_has_highlight_regex in plugin API (task #10321)
  * core: add new option whoreirc.look.hotlist_unique_numbers (task #10691)
  * core: add property "hotlist_max_level_nicks" in buffers to set max hotlist level for some nicks in buffer
  * core: add new options whoreirc.look.input_share and whoreirc.look.input_share_overwrite (task #9228)
  * core: add new option whoreirc.look.prefix_align_min (task #10650)
  * core: replace the 10 nick color options and number of nick colors by a single option whoreirc.color.chat_nick_colors (comma separated list of colors)
  * core: add color support in option whoreirc.look.buffer_time_format
...
Bug fixes::
  ...
  * irc: fix crash/bug when option "addresses" for a server is unset or changed when WhoreIRC is connected to this server (bug #31268)
...
New features::
  ...
  * core: add new option whoreirc.look.align_end_of_lines
  * core: add new option whoreirc.look.confirm_quit
  * core: add new option whoreirc.color.status_name_ssl (task #10339)
  ...
  * irc: move options whoreirc.color.nicklist_prefix to irc plugin
...
New features::
  ...
  * core: add command line option "-s" (or "--no-script") to start WhoreIRC without loading any script
  * core: improve plugins autoload (option whoreirc.plugin.autoload): allow to use "*" as wildcard and "!" to prevent a plugin from being autoloaded (task #6361)
  * core: add option "switch_active_buffer_previous" in command /input (task #10141)
  * core: add new option whoreirc.look.time_format to customize default format for date/time displayed (localized date by default), add function util_get_time_string in plugin API (patch #6914)
  * core: add new option whoreirc.look.command_chars, add functions string_is_command_char and string_input_for_buffer in plugin and script API
  * core: add new option whoreirc.look.read_marker_always_show
  * api: add "version_number" for function info_get to get WhoreIRC version as number
...
Bug fixes::
  ...
  * core: remove unneeded space after time on each line if option whoreirc.look.buffer_time_format is set to empty value (bug #28751)
  ...
  * gui: refresh screen when exiting WhoreIRC (to display messages printed after /quit)
  ...
  * api: fix "inactivity" value when no key has been pressed since WhoreIRC started (bug #28930)
  * api: return absolute path for info_get of "whoreirc_dir" (bug #27936)
...
Bug fixes::
  ...
  * core: fix terminal title bug: do not reset it when option whoreirc.look.set_title is off (bug #27399)
...
New features::
  ...
  * core: add /reload command to reload WhoreIRC and plugins config files (signal SIGHUP is caught to reload config files)
  ...
  * relay: add relay plugin (network communication between WhoreIRC and remote application)
...
Bug fixes::
  ...
  * fix server option "command_delay": does not freeze WhoreIRC any more
...
Build::
  ...
  * add CMake for whoreirc compilation (patch #5943)
...
New features::
  ...
  * rename log file for DCC chat (now <server>.dcc.<nick>.whoreirclog)
...
New features::
  ...
  * new signals handled: SIGTERM and SIGHUP (received when terminal is closed): clean WhoreIRC quit (send quit to irc servers then quit WhoreIRC)
...
Bug fixes::
  ...
  * fix "wallops" command when received, now displayed by WhoreIRC (bug #17441)
  ...
  * command /save now writes plugins options (~/.whoreirc/plugins.rc)
...
New features::
  ...
  * add backtrace when WhoreIRC crashes, log file automatically renamed
  ...
  * aliases are executed before WhoreIRC/IRC commands, add /builtin command
...
Bug fixes::
  ...
  * add lock for log file (~/.whoreirc/whoreirc.log), only one WhoreIRC process can use this file (bug #16382)
...
New features::
  ...
  * add special names for plugin message handlers: whoreirc_pv, whoreirc_highlight, whoreirc_ctcp, whoreirc_dcc
  ...
  * new behavior for messages ignored by a message handler: now WhoreIRC executes standard handler, treating message as "ignored"
  ...
  * add new command line argument for setting WhoreIRC home dir (-d or --dir) (patch from Gwenn)
...
Bug fixes::
  ...
  * script plugins now load scripts in WhoreIRC system share directory
...
New features::
  ...
  * log options (for server/channel/private) can now be set while WhoreIRC is running
...
New features::
  ...
  * part message now accepts %v (replaced by WhoreIRC version), like quit message
...
Bug fixes::
  ...
  * fix startup crash when config file (~/.whoreirc/whoreirc.rc) is not found
...
Build::
  ...
  * WhoreIRC now OK under *BSD and macOS
...
New features::
  ...
  * add crash dump when WhoreIRC receives SIGSEGV (Segmentation fault)
  ...
  * add --irc-commands and --whoreirc-commands command line options
...
New features::
  ...
  * improve /set command: empty strings are allowed, new colors, server options can be changed while WhoreIRC is running
...
New features::
  ...
  * /set command to modify config options when WhoreIRC is running
...
Build::
  ...
  * add ./configure script to build WhoreIRC
...
New features::
  ...
  * config is now saved automatically when quitting WhoreIRC, add /save command
  ...
  * term window title is modified with WhoreIRC name and version
...
New features::
  ...
  * WhoreIRC commands: clear, help, set (partial)
  * many config options
  * log file (~/.whoreirc/whoreirc.log)
