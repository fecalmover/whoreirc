...
Bug fixes::
  ...
  * core: change default value of option whoreirc.look.window_title from "WeeChat ${info:version}" to empty string (issue #1182)
...
New features::
  ...
  * core: add binary whoreirc-headless to run WeeChat without interface, with optional daemon mode (command line option "--daemon") (issue #1120)
...
New features::
  ...
  * core: add option whoreirc.startup.sys_rlimit to set system resource limits for WeeChat process
...
Build::
  ...
  * core: add WEECHAT_HOME option in CMake and configure to setup default WeeChat home (default is "~/.whoreirc") (task #11266)
...
Bug fixes::
  ...
  * add lock for log file (~/.whoreirc/whoreirc.log), only one WeeChat process can use this file (bug #16382)
